...
//        }
    ...
    public static String getCustomNameSerialized(@NotNull ItemMeta meta) {
        ...
        return name == null ? null : NightMessage.stripTags(name, TagPool.ALL); // MiniMessage moment
    }
    ...
    public static List<String> getLoreSerialized(@NotNull ItemMeta meta) {
        ...
        return lore == null ? new ArrayList<>() : Lists.modify(lore, line -> NightMessage.stripTags(line, TagPool.ALL)); // MiniMessage moment
    }
